                        ...
                        <div className="relative w-16 h-16 mr-2 sm:mr-4">
                          <Image 
                            src={(() => {
                              ...
                              const imageSrc = item.image || item.product?.image_1;
                              if (!imageSrc) return '/engine1.png';
                              
                              // Handle Buffer/blob images (base64)
                              if (typeof imageSrc === 'string' && imageSrc.length > 100 && !imageSrc.startsWith('http') && !imageSrc.startsWith('/') && !imageSrc.startsWith('data:')) {
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex">
                    ...
                    <button
                      onClick={applyCoupon}
                      className="bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white px-4 py-2 rounded-r transition"
                    >
                      Apply
                    </button>
                  </div>
                ...
                {isLoggedIn ? (
                  <Link 
                    href="/checkout"
                    className="w-full bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white py-3 px-6 rounded-lg transition mt-6 inline-block text-center"
                  >
                    Proceed to Checkout
                  </Link>
                ) : (
